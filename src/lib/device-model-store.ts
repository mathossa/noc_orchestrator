...
export async function getDeviceModel(id: string) {
  ...
  return {
    ...
    desiredFirmware: {
      ...
      minimumRelease: desiredPolicy?.minimumRelease ?? null,
      maximumRelease: desiredPolicy?.maximumRelease ?? null,
      minimumInclusive: desiredPolicy?.minimumInclusive ?? true,
      maximumInclusive: desiredPolicy?.maximumInclusive ?? true,
      firmwareTrain: desiredPolicy?.firmwareTrain ?? null,
